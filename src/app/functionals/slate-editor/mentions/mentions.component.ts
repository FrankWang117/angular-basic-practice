...
import { CustomEditor, MentionElement } from 'src/types';

@Component({
    selector: 'functional-editor-mentions',
    templateUrl: 'mentions.component.html',
})
export class FunctionalEditorMentionsComponent implements OnInit {
    public title = 'Mentions';
    ...
    valueChange(value: Element[]): void {
    ...
    updateSuggestionsLocation() {
        ...
        if (this.target && this.suggestions.length) {
            const nativeRange = AngularEditor.toDOMRange(
                this.editor,
                this.target
            );
